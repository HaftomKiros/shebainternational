...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('shortlisted_report'); ?></h1>
            <small><?php echo display('show_shortlisted_report'); ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home'); ?></a></li>
                <li><a href="#"><?php echo display('shortlisted_report'); ?></a></li>
                <li class="active"><?php echo display('show_shortlisted_report'); ?></li>
            </ol>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <!-- Shortlisted Report Table -->
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('shortlisted_report'); ?></h4>
                        </div>
                    </div>

                    <div class="panel-body panel-body-scroll">
                        <table id="shortlistedList" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th><?php echo display('sno'); ?></th>
                                    <th><?php echo display('company_id'); ?></th>
                                    <th><?php echo display('company_name'); ?></th>
                                    <th><?php echo display('total_shortlisted'); ?></th>
    ...
    <?php 
    $sl = 1;
    if (!empty($shortlisted_report)) { // Use $shortlisted_report here instead of $shortlisted_data
        foreach ($shortlisted_report as $data) {
            // Assuming $data contains company_id, company_name, shortlisted count, and total jobs posted
    ?>
        <tr>
            <td><?php echo $sl++; ?></td>
            <td><?php echo html_escape($data['id']); ?></td>
            <td><?php echo html_escape($data['company_name']); ?></td>
            <td><?php echo html_escape($data['total_shortlisted']); ?></td>
